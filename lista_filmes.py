...
def movies():
    filmes = ['Homem-aranha', 'Vingadores', 'Senhor dos aneis', 'homem de ferro',
          ...
          'Atividade paranormal', ' O poderoso chefão', 'Eu sou a lenda', 'Contagio',
          'Noite dos mortos vivos', 'Auto da compadecida', 'Dona flor e seus dois maridos',
          'Central do Brasil', 'Contato', 'Interestelar', '2001: uma odisseia no espaço',
